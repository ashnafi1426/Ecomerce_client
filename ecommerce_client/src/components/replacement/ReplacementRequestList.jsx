...
/**
 * ReplacementRequestList Component
 * 
 * Displays paginated list of customer's replacement requests with status filtering.
 * 
 * Requirement: 1.1
 * Task: 36.1
 */
            ...
            >
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {request.status === 'approved' && request.replacement_order_id && (
                    <div className="bg-green-50 border border-green-200 rounded p-3">
                      <p className="text-sm text-green-800">
                        ✅ Replacement approved! A new order has been created.
                      </p>
                      <Link
                        to={`/orders/${request.replacement_order_id}`}
                        className="text-sm text-[#FF9900] hover:underline font-semibold mt-1 inline-block"
                      >
                  ...
                  {request.status === 'pending' && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                      <p className="text-sm text-yellow-800">
                        ⏳ Your request is being reviewed by the seller. You'll be notified once a decision is made.
                      </p>
                    </div>
                  )}
...
ReplacementRequestList.propTypes = {
...
export default ReplacementRequestList
